...
const companies = [
  ...
  {
    name: "GreenTech",
    logo: "https://randomuser.me/api/portraits/women/78.jpg",
  },
  { name: "FinEdge", logo: "https://randomuser.me/api/portraits/men/88.jpg" },
  {
    name: "Marketly",
    logo: "https://randomuser.me/api/portraits/women/90.jpg",
  },
];
...
const vacancies: Vacancy[] = Array.from({ length: 50 }, (_, i) => {
  ...
  return {
    ...
    applyLink:
      i % 3 === 0 ? "https://apply.example.com/job/" + (i + 1) : undefined,
                  ...
                  {showEmail && selectedVacancy?.email && (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2 bg-green-500 text-white font-semibold rounded-b-lg px-4 py-2 cursor-pointer select-all mt-0.5 relative">
                        ...
                        />
                        <span className="border-l border-white/30 pl-3 text-xs">
                          {selectedVacancy.email}
                        </span>
                        <span
                        ...
                        >
                          {copied ? (
                            ...
                            <FiCopy className="w-4 h-4 text-white justify-self-end" />
                          )}
                        </span>
                        <AnimatePresence>
